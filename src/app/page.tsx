                    ...
                    <div className="relative z-[30] mx-auto max-w-4xl w-full text-center">
                        ...
                        <div className="max-w-3xl lg:max-w-4xl mx-auto">
                            ...
                            <p className="text-base sm:text-lg text-[#a0aec0] leading-relaxed mb-8 max-w-xl mx-auto">
                                ...
                                hands-on workshop, dive into a 36-hour
                                hackathon, and showcase your talent in front of
                                industry experts. Whether you&apos;re a beginner
                                or a pro, this is your chance to build, learn,
                                and leave your mark.
                            </p>
