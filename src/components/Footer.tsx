...
export default function Footer() {
    return (
        <footer
            id="contact"
            className="relative px-6 py-20 bg-[#0f1419] overflow-hidden"
        >
            <SectionBackground variant="default" />
            <div className="relative mx-auto max-w-7xl">
                <SpotlightCard className="p-8 md:p-10 backdrop-blur-xl">
                ...
                <div className="mt-10 text-center text-[#a0aec0]">
                    <p className="text-sm">
